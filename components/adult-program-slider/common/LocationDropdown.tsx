...
const LocationDropdown: React.FC<LocationDropdownProps> = ({
  ...
  return (
    ...
    >
      <motion.div className="mb-4 md:mb-0 md:mr-8" variants={itemVariants}>
        <motion.div className="font-bold text-lg mb-2" variants={itemVariants}>
          {title}
        </motion.div>
        <motion.div variants={arrowVariants} animate="bounce">
          <ArrowDown size={24} className="mx-auto" />
        </motion.div>
        <motion.div className="flex justify-center gap-4 mt-2" variants={itemVariants}>
      ...
      {subtitle && (
        <motion.div className="text-center" variants={itemVariants}>
          <motion.div className="text-lg font-bold text-gray-700 mb-2" variants={itemVariants}>
            {subtitle}
          </motion.div>
        </motion.div>
      )}
